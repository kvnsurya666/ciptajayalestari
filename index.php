      ...
      <div class="container-fluid p-0">
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6 my-auto showcase-text">
            ...
            <div class="shop-button">
              <a href="measuringtool.php">Lihat Disini</a>
            </div>
          </div>
        </div>
        <div class="row g-0">
          ...
          <div class="col-lg-6 order-lg-1 my-auto showcase-text">
            ...
            <div class="shop-button">
              <a href="handtool.php">Lihat Disini</a>
            </div>
          </div>
        </div>
        <div class="row g-0">
          ...
          <div class="col-lg-6 my-auto showcase-text">
            ...
            <div class="shop-button">
              <a href="cuttingcoolant.php">Lihat Disini</a>
            </div>
          </div>
        </div>
        <div class="row g-0">
          ...
          <div class="col-lg-6 order-lg-1 my-auto showcase-text">
            ...
            <div class="shop-button">
              <a href="abrasive.php">Lihat Disini</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer_agileinfo_w3">
      <div class="footer_inner_info_w3ls_agileits">
        <div class="row">
          ...
          <div class="col-md-4">
            <div
              class="sign-gd-two emailprofile cta-footer text-center footer-right"
              id="wa_company"
              data-wa="6281335700084;6281330066919;628123170863;6281254693810;6281331637497;085232777499"
              data-company="//www.ciptajayalestari.com"
              data-member="2"
            >
              <div id="wa">
                <div class="phone-domain">
