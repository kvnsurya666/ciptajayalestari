...
<?= $this->section('title'); ?>
<title>Tambah Data Barang | CJL</title>
<?= $this->endSection(); ?>
  ...
  <section class="section mt-2">
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?= site_url('barang'); ?>" class="form" method="POST" autocomplete="off" enctype="multipart/form-data">
          <div class="row">
            <?= csrf_field(); ?>
              ...
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= $validation->hasError('nama_barang') ? 'is-invalid' : null ?>" name="nama_barang" value="<?= old('nama_barang'); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <select name="id_kategori" class=" form-select <?= $validation->hasError('id_kategori') ? 'is-invalid' : null ?>">
                      ...
                      <?php foreach ($kategori as $key => $value) : ?>
                        <option value="<?= $value->id_kategori; ?>" <?= old('id_kategori') == $value->id_kategori ? 'selected' : null; ?>><?= $value->nama_kategori; ?></option>
                      <?php endforeach ?>
                    </select>
                    <div class="invalid-feedback">
              ...
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <textarea name="desk_barang" class="form-control"></textarea>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <img src="<?= base_url(); ?>/assets/img/barang/default.png" class="img-thumbnail img-preview" alt="Logo">
                </div>
              </div>
            </div>
