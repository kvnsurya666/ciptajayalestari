          ...
          <div class="row">
            ...
            <div class="col-md-6 col-12">
              <div class="form-group">
                ...
                <input type="number" class="form-control <?= $validation->hasError('phone_sales') ? 'is-invalid' : null ?>" name="phone_sales" value="<?= old('phone_sales'); ?>">
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 col-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= $validation->hasError('alamat_sales') ? 'is-invalid' : null ?>" name="alamat_sales" value="<?= old('alamat_sales'); ?>">
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 col-12">
              <div class="form-group">
                ...
                <input type="date" class="form-control <?= $validation->hasError('tgl_lahir_sales') ? 'is-invalid' : null ?>" name="tgl_lahir_sales" value="<?= old('tgl_lahir_sales'); ?>">
                <div class="invalid-feedback">
